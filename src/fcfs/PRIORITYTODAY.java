 ...
 * @author Dell
 */
public class PRIORITYTODAY extends javax.swing.JFrame {
int n;
int at[]=new int[89];
int bt[]=new int[89];
int pt[]=new int[89];
...
DefaultListModel list3 = new DefaultListModel();   
    ...
    /**
     * Creates new form PRIORITYTODAY
     */
    public PRIORITYTODAY() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel8.setText("PRIORITY(Preemptive)");
    ...
    int i,j,time,sum_wait=0,sum_turnaround=0,smallest;
  int rt[]=new int[15];
  int remain;
  double awti,atti;
  remain=n;
  ...
  awti=sum_wait*1.0/n;
  atti=sum_turnaround*1.0/n;
      
        att1.setText(String.valueOf(atti));
        aw1.setText(String.valueOf(awti));
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        RUNSCHE frame1212111=new RUNSCHE();
        PRIORITYTODAY.this.setVisible(false);
        frame1212111.setVisible(true);          // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PRIORITYTODAY.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PRIORITYTODAY().setVisible(true);
            }
        });
    }
